...
class CustomerGroupsController extends Controller
{
    public function index()
    {
        ...
        return response()->json(['success'=>true,'data'=>$CustomerGroup,'total'=>count($CustomerGroup)]);
    }
    public function store(Request $request)
    {
        ...
        $customerGroupDesc['language_id'] = config_language_id;
    ...
    public function edit($id)
    {
        ...
        return response()->json(['success'=>true,'data'=>$groupArr,'total'=>count($groupArr)]);
    }
